### [![Typing SVG](https://readme-typing-svg.herokuapp.com/?type=waving&color=0000ff&size=35&center=true&vcenter=true&width=1400&lines=Hi+there,+my+name+is+Alan+Corrêa;Welcome+to+my+profile+🖖)](https://git.io/typing-svg)
...
🧐 **In the future, I intend to pursue a master's degree in the area with a focus on green computing, analytics, data science and, if possible, merging this knowledge with AI.**
...
### 🎯 **Frameworks na mira do aprendizado** - **Frameworks in the sights of learning**
 ![Apache Spark](https://img.shields.io/badge/Apache%20Spark-FDEE21?style=flat-square&logo=apachespark&logoColor=black) ![Apache Kafka](https://img.shields.io/badge/Apache%20Kafka-000?style=for-the-badge&logo=apachekafka)
